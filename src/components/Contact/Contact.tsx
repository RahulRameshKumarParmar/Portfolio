        ...
        <Col xs={12} md={6}>
          <div className="contactDetails d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="p-2">
              ...
              <a className="noHighlight" href="https://github.com/RahulRameshKumarParmar" target="_blank" rel="noreferrer noopener">
                <FontAwesomeIcon className="githubBox" icon={faGithub} size="1x" />
              </a>
              <a className="noHighlight" href="https://www.linkedin.com/in/rahul-parmar-a34a0b262/" target="_blank" rel="noopener noreferrer">
