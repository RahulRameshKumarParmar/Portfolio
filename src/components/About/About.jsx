...
export default function About() {
    ...
    const Text = "I'm Rahul Parmar, a passionate front-end developer with a focus on creating responsive and user-friendly web interfaces. Currently I'm improving my skills in React and working on personal projects to sharpen my problem-solving abilities.";
